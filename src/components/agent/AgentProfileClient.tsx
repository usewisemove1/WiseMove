  ...
  return (
      <>
        <PageShell dataComponent="agent-profile" innerClassName="pb-12 pt-0">
          ...
          {/* Bio & Agent Verification section */}
          <section data-component="agent-profile-bio" className="mt-10">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12">
              ...
              {/* Right Column: Verification Aside with light grey divider */}
              <div className="flex flex-col lg:col-span-1 lg:border-l lg:border-border lg:pl-8">
                <aside className="h-fit rounded-2xl border border-border bg-white p-5 shadow-sm">
                  <div className="flex items-center gap-2 text-foreground">
                    <ShieldCheck className="h-5 w-5 text-primary" />
                    <h2 className="font-bold">Agent Verification</h2>
                  </div>
                  <p className="mt-3 text-sm leading-6 text-muted-foreground">
                    This professional&apos;s identity and agency credentials have been checked by WiseMove.
                  </p>
                  <div className="mt-5 space-y-3 border-t border-border pt-5">
                    <a href={`tel:+${agent.phone}`} className="flex items-center gap-3 text-sm font-semibold text-foreground hover:text-primary">
                      <Phone className="h-4 w-4 text-primary" /> +{agent.phone}
                    </a>
                    <a href={`mailto:${agent.email}`} className="flex items-center gap-3 break-all text-sm font-semibold text-foreground hover:text-primary">
                      <Mail className="h-4 w-4 shrink-0 text-primary" /> {agent.email}
                    </a>
                  </div>
                  <Button asChild className="mt-5 w-full">
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">Message agent</a>
                  </Button>
